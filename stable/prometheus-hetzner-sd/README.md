...
![Version: 3.2.12](https://img.shields.io/badge/Version-3.2.12-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.2.14](https://img.shields.io/badge/AppVersion-2.2.14-informational?style=flat-square)

A Helm chart for Prometheus Hetzner SD

**Homepage:** <https://promhippie.github.io/prometheus-hetzner-sd/>
...
```console
helm install prometheus-hetzner-sd oci://ghcr.io/promhippie/charts/prometheus-hetzner-sd
```
...
* <https://github.com/promhippie/prometheus-hetzner-sd>
...
| files | object | `{}` | List of files written to a configmap and mounted to /etc/prometheus-hetzner-files |
| fullnameOverride | string | `""` | Override the fullname |
| image.pullPolicy | string | `"IfNotPresent"` | Image pull policy |
| image.pullSecrets | list | `[]` | Optional name of pull secret if using a private registry |
| image.repository | string | `"quay.io/promhippie/prometheus-hetzner-sd"` | Image repository used by deployment |
...
| sd.output | string | `"/etc/prometheus-hetzner-sd/hetzner.json"` | Path to write the service discovery result to |
